...
--
-- 转存表中的数据 `n969_27hfwmistt`
--

INSERT INTO `n969_27hfwmistt` (`_id`, `部门名称`, `上级部门ID`, `是否禁用`, `是否删除`, `_create`, `_update`) VALUES
(1, '总部', '0', '0', '0', 1677122416, 1677122476),
(2, '00', NULL, '0', '0', 1682476964, 1682476964);
...
--
-- 转存表中的数据 `n969_etnezksayk`
--

INSERT INTO `n969_etnezksayk` (`_id`, `key`, `菜单名称`, `上级菜单ID`, `类型`, `排序`, `页面路径`, `接口路径`, `是否禁用`, `是否删除`, `_create`, `_update`) VALUES
...
--
-- 转存表中的数据 `n969_hdbhcrwh23`
--

INSERT INTO `n969_hdbhcrwh23` (`_id`, `用户名`, `手机号`, `邮箱`, `昵称`, `姓名`, `密码`, `角色ID`, `部门ID`, `是否禁用`, `是否删除`, `_create`, `_update`) VALUES
...
--
-- 转存表中的数据 `n969_ihj2cmawrr`
--

INSERT INTO `n969_ihj2cmawrr` (`_id`, `角色名称`, `菜单IDs`, `是否禁用`, `是否删除`, `_create`, `_update`) VALUES
...
--
-- 表的索引 `n969_27hfwmistt`
--
ALTER TABLE `n969_27hfwmistt`
  ADD PRIMARY KEY (`_id`);


--
-- 表的索引 `n969_etnezksayk`
--
ALTER TABLE `n969_etnezksayk`
  ADD PRIMARY KEY (`_id`);

--
-- 表的索引 `n969_hdbhcrwh23`
--
ALTER TABLE `n969_hdbhcrwh23`
  ADD PRIMARY KEY (`_id`);

--
-- 表的索引 `n969_ihj2cmawrr`
--
ALTER TABLE `n969_ihj2cmawrr`
  ADD PRIMARY KEY (`_id`);
...
--
-- 使用表AUTO_INCREMENT `n969_27hfwmistt`
--
ALTER TABLE `n969_27hfwmistt`
